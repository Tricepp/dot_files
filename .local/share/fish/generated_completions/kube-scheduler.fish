...
complete -c kube-scheduler -l contention-profiling -d '	DEPRECATED: enable lock contention profiling, if profiling is enabled'
...
complete -c kube-scheduler -l lock-object-name -d '	DEPRECATED: define the name of the lock object'
complete -c kube-scheduler -l lock-object-namespace -d '	DEPRECATED: define the namespace of the lock object'
...
complete -c kube-scheduler -l version -d '	Print version information and quit'
